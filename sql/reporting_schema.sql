...
CREATE TABLE IF NOT EXISTS ingest.participants (
    ...
    -- Source-file columns that used to live only inside extra_json (see
    -- sql/migrations/0002_add_participant_source_columns.sql).
    region              TEXT,
    region_group        TEXT,
    assistive_device    TEXT,
    primary_language    TEXT,
    employment_status   TEXT,
    income_activity     TEXT,
    monthly_income      TEXT,
    internet_frequency  TEXT,
    device_used         TEXT,
    self_rated_digital_skill TEXT,
    cdc_name            TEXT,
    cdc_phone           TEXT,
    ...
    where_course_taken  TEXT,
    date_trained        TEXT,
    kictanet_cluster    TEXT,
    has_device          TEXT,
    internet_type       TEXT,
    source              TEXT,
    partner             TEXT,
